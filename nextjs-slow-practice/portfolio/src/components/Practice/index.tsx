...
//         <div>
//             <div
//                 className="bg-red-500 h-60 w-60 items-center flex justify-center hover:scale-x-[-1] duration-1000"
//             // className="bg-red-500 h-60 w-60 items-center flex justify-center transform scaleX(-1)"
//             >
//                 Lets See...
//             </div>
//         </div>
...
// //                         <p className="text-xl font-bold">Front Side</p>
// //                     </div>

// //                     {/* <!-- Back Side --> */}
// //                     <div className="absolute w-full h-full bg-red-500 text-white flex items-center justify-center transform rotate-y-180 backface-hidden">
